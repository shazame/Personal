...
local function set_wallpaper(s)
 ...
 upicon = wibox.widget.imagebox(beautiful.widget_netup, false)
...
-- {{{ Tags #Modif
	...
	names = { "www", "code", "music", "image", "o" }
	layout = { awful.layout.layouts[4], awful.layout.layouts[2], awful.layout.layouts[2], awful.layout.layouts[1], awful.layout.layouts[2] }
...
globalkeys = gears.table.join(
	...
	-- Screen Backlight
	awful.key({ modkey,           }, "F5",    function () awful.spawn("backlightset down")   end,
              {description = "Decrease screen backlight", group = "custom"}),
	awful.key({ modkey,           }, "F6",    function () awful.spawn("backlightset up")     end,
              {description = "Increase screen backlight", group = "custom"}),

	-- Keyboard Backlight
	awful.key({ modkey,           }, "F3",    function () awful.spawn("kbdbacklight down")   end,
              {description = "Decrease keyboard backlight", group = "custom"}),
	awful.key({ modkey,           }, "F4",    function () awful.spawn("kbdbacklight up")     end,
              {description = "Increase keyboard backlight", group = "custom"}),

	-- Sound
	awful.key({ modkey,           }, "F10",    function () davidus.sound_mute()              end,
              {description = "Decrease sound", group = "custom"}),
	awful.key({ modkey,           }, "F11",    function () davidus.sound_down()              end,
              {description = "Increase sound", group = "custom"}),
	awful.key({ modkey,           }, "F12",    function () davidus.sound_up()                end,
              {description = "Mute/unmute sound", group = "custom"}),
	...
	awful.key({ modkey,           }, "F8",     function () davidus.xrandr()                  end,
              {description = "Change screen layout", group = "custom"})
    -- }}}
)
