...
alias goeuler='cd /home/david/Documents/Personnal_Test/Project\ Euler/'
alias blender='~/Logiciels/blender-2.61-linux-glibc27-i686/blender'
alias goc='cd /home/david/ENSEIRB-MATMECA/S8/Cours'
alias gopro='cd /home/david/ENSEIRB-MATMECA/S8/Projets'
alias go='cd /home/david/aversive/aversive.b_eirbot/projects/coupe2012/1A'
alias za='zathura'
alias ssh-enseirb='ssh dbitonneau@ssh.enseirb-matmeca.fr'
...
# décommenter pour utiliser les raccourcis vim dans bash
#set -o vi

# Super fonction pour créer et rentrer dans un dossier
mkcd ()
{
	mkdir $1 && cd $1
}
...
export PERL5LIB="/home/david/perl5/lib/perl5/i686-linux-gnu-thread-multi-64int:/home/david/perl5/lib/perl5";
export PATH="/home/david/perl5/bin:$PATH";

# Uncomment this to synchronize terminals' history
